"""
Django settings for network_topology project.
"""
...
if (BASE_DIR_PATH / '.env.local').exists():
    load_dotenv(BASE_DIR_PATH / '.env.local')
else:
    load_dotenv()
...
ROOT_URLCONF = 'network_topology.urls'
...
WSGI_APPLICATION = 'network_topology.wsgi.application'
